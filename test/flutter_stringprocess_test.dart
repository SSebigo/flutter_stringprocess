...
void main() {
  ...
  group('Core :', () {
    ...
    test('duplicateLine', () {
      ...
      expect(tps.duplicateLine('amouse\n', 5), 'amouse\namouse\n');
      expect(tps.duplicateLine('bmonkey\n', 6), 'bmonkey\nbmonkey\n');
      expect(tps.duplicateLine('cmonkey\n', 7), 'cmonkey\ncmonkey\n');
      expect(tps.duplicateLine('dmonkey\n', 8), 'dmonkey\ndmonkey\n');

      expect(tps.duplicateLine('this is more like a sentence', 8),
          'this is more like a sentence\nthis is more like a sentence\n');
    });
